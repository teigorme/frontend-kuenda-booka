  ...
  return (
    <div className="lg:flex justify-between items-start w-full gap-4 h-full">
      <div className="lg:w-[75%]">
        <div className="relative w-full h-96 bg-black rounded-2xl overflow-hidden shadow-lg border border-gray-700">
          <Image
            src="/images/1.png"
        ...
        <div className="bg-gray-300 p-2 mt-4 rounded-2xl text-justify">
          <h2>
      ...
      <div className="lg:w-[25%] lg:pt-0 pt-4">
